...
namespace Evento.Core.Domain
{
    public class Ticket : Entity
    {
        ...
        public DateTime? PruchasedAt { get; protected set; }
        ...
        public void Purchase(User user)
        {
            if(Purchased)
            {
                throw new Exception($"Ticket was already purchased by user: '{Username}' at: '{PruchasedAt}'.");
            }
            UserId = user.Id;
            Username = user.Name;
            PruchasedAt = DateTime.UtcNow;
        }
